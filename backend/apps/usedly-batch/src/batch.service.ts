...
import { Member } from 'apps/usedly-api/src/libs/dto/member/member';
import { Property } from 'apps/usedly-api/src/libs/dto/property/property';
import { MemberStatus, MemberType } from 'apps/usedly-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/usedly-api/src/libs/enums/property.enum';
...
export class BatchService {
	...
	public getHello(): string {
		return 'Welcome to Usedly BATCH Server!';
	}
}
