...
import { PropertyLocation, PropertyType, PropertyBrand } from '../../enums/property.enum';
...
const AddProperty = ({ initialValues, ...props }: any) => {
	...
	const [insertPropertyData, setInsertPropertyData] = useState<Property>(initialValues);
							...
							<Stack className="config-row">
								<Stack className="price-year-after-price">
									...
									<input
										...
										className="description-input"
										placeholder={'Price'}
										value={insertPropertyData.propertyPrice === 0 ? '' : insertPropertyData.propertyPrice}
										onChange={({ target: { value } }) =>
											setInsertPropertyData({
												...insertPropertyData,
												propertyPrice: value === '' ? 0 : parseInt(value),
											})
										}
